...
const changeValue = (e) => {
  ...
  if (id === 'workMore' || id === 'workLess') {
    ...
    !resting ? counter.textContent = `${changeWork}.${seconds}` : null;
    !resting ? minutes = changeWork : null;
    ...
    resting ? counter.textContent = `${changeBreak}.${seconds}` : null;
    resting ? minutes = changeBreak : null;
